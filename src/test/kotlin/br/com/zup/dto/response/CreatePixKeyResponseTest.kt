...
class CreatePixKeyResponseTest {
    ...
    fun `test CreatePixKeyResponseDto constructor and getters`() {
        val actual = CreatePixKeyResponse("CPF", "06628726061", bankAccount, owner,
            "2021-01-12T15:34")
    ...
    fun `test CreatePixKeyResponseDto toModel`() {
        val pixResponse = CreatePixKeyResponse("CPF", "06628726061", bankAccount, owner,
            "2021-01-12T15:34")
        ...
        assertEquals(null, actual.ownerId)
